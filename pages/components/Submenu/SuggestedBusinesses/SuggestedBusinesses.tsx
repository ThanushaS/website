...
const SuggestedBusinesses = () => {
  return (
    <div className='container-fulid mt-5' style={{marginLeft:'114px'}}>
      ...
      <div className="row">
        <div className="col-4 col-md border">
          ...
          <label className="form-label1" htmlFor="form3Example3">Contact:</label>
            <input type="text" id="form3Example3" className="form-control2"  style={{width:'376px',height:'37px'}}/>
          </div>
          </div>
          <div className="form-outline">
      ...
      className="map h-100 w-100"  loading="lazy"style={{width:'842px',height:'465px'}}></iframe>
         </div>
      </div>
      </div>
